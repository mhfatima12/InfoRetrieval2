...
//        IndexConstructor indexConstructor = new IndexConstructor();
        ...
        Directory dir = FSDirectory.open(Paths.get(FT_DIR));
        ...
        indexWriterConfig.setOpenMode(IndexWriterConfig.OpenMode.CREATE_OR_APPEND);
        indexWriterConfig.setSimilarity(new BM25Similarity());
        dir = FSDirectory.open(Paths.get(FBI_DIR));
        ...
        indexWriterConfig.setOpenMode(IndexWriterConfig.OpenMode.CREATE_OR_APPEND);
        indexWriterConfig.setSimilarity(new BM25Similarity());
        dir = FSDirectory.open(Paths.get(FR94_DIR));
        indexWriter = new IndexWriter(dir, indexWriterConfig);
        ...
        indexWriterConfig.setOpenMode(IndexWriterConfig.OpenMode.CREATE_OR_APPEND);
        indexWriterConfig.setSimilarity(new BM25Similarity());
        dir = FSDirectory.open(Paths.get(LATIMES_DIR));
        indexWriter = new IndexWriter(dir, indexWriterConfig);
